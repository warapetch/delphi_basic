...
type
  TFrmQryTrans_Result = class(TFrmTemplate_Base)
    pnlToolBar: TPanel;
    dbgData: TDBGrid;
    cbbClass: TComboBox;
    btnSearch: TBitBtn;
...
var
  FrmQryTrans_Result: TFrmQryTrans_Result;
...
procedure TFrmQryTrans_Result.btnReportClick(Sender: TObject);
begin
...
procedure TFrmQryTrans_Result.btnSearchClick(Sender: TObject);
begin
...
procedure TFrmQryTrans_Result.cbbClassCloseUp(Sender: TObject);
begin
	btnSearchClick(Self);
end;
