inherited FrmQryTrans_Result_Top10: TFrmQryTrans_Result_Top10
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3612#3621#3585#3634#3619#3648#3619#3637#3618#3609' (Top10)'
  ClientWidth = 753
  ExplicitWidth = 769
  PixelsPerInch = 96
  TextHeight = 17
  ...
  object qryData: TFDQuery
    ...
    SQL.Strings = (
      ...
      'order by cast(tr.st_grade as integer) desc'
      'limit 10 -- '#3649#3626#3604#3591#3649#3588#3656' 10 '#3588#3609)
    Left = 472
    Top = 192
    ParamData = <
      item
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              #3619#3634#3618#3591#3634#3609#3612#3621#3585#3634#3619#3648#3619#3637#3618#3609' TOP-10 [<data."st_class">]  '#3648#3607#3629#3617' [data."st_term' +
              'no"]')
          ParentFont = False
          Formats = <
            item
